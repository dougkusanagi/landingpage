                 ...
                 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required name="PURCHASE_CODE" value="{{ old('PURCHASE_CODE') }}" class="form-control" placeholder="Enter random value">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Enter username envato</label>
                            <input type="text" name="USER_NAME_OR_EMAIL" value="{{ old('USER_NAME_OR_EMAIL') }}" class="form-control" placeholder="Enter random Email or Username">
                        </div>
                    </div>
                </div>
